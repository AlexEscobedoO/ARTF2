    ...
    public class ConstanciaCancelacion
    {
        public IActionResult Generar(Equiuni equiuni, string homoclave)
        {
            ...
            using (var pdfStream = new MemoryStream())
            {
                ...
                string imagePath1 = Path.Combine(projectDirectory, "Helpers", "Resources", "SCT LOGO.png");
                string imagePath2 = Path.Combine(projectDirectory, "Helpers", "Resources", "ARTF.png");
                string marcadeagua = Path.Combine(projectDirectory, "Helpers", "Resources", "FONDO.png");
                ...
                PdfPCell cell3 = new PdfPCell(CreateCustomSubTable1(equiuni.ModaEqui.Description));
                ...
                PdfPCell cell4 = new PdfPCell(CreateCustomSubTable2(equiuni.Matricula,equiuni.Fcons));
                cell4.Border = Rectangle.LEFT_BORDER | Rectangle.RIGHT_BORDER; // Poner el borde izquierdo y derecho
                table.AddCell(cell4);

                //ROW (MODELO Y TIPO DE EQUIPO)
                PdfPCell cell5 = new PdfPCell(CreateCustomSubTable3(equiuni.ModaequiIdNavigationNavigation.Modequi, equiuni.TipequiIdNavigationNavigation.Description));
                cell5.Border = Rectangle.LEFT_BORDER | Rectangle.RIGHT_BORDER; // Poner el borde izquierdo y derecho
                table.AddCell(cell5);

                //ROW (MARCA Y TIPO DE USO)
                PdfPCell cell6 = new PdfPCell(CreateCustomSubTable4(equiuni.Marca.RsMarca, equiuni.UsoequiIdNavigationNavigation.Usoequi1));
                ...
                PdfPCell cell8 = new PdfPCell(CreateCustomSubTable6(equiuni.Fabricante.Rsfab, equiuni.Graequi == true ? "Si" : "No"));
                ...
                // ROW (PROPIO, RENTADO)
                PdfPCell cell3Table2 = new PdfPCell(CreateCustomSubTable2_1(equiuni.RegiequiIdNavigationNavigation.Regimen));
                ...
                PdfPCell cell5Table2 = new PdfPCell(CreateCustomSubTable2_3(equiuni.Empresa.Rsempre));
                ...
                PdfPCell cell6Table2 = new PdfPCell(CreateCustomSubTable2_4(equiuni.Empresa.Rsempre));
                ...
                // Añadir celda de título
                PdfPCell titleCellTable3 = new PdfPCell(new Phrase($"DATOS DE LA CANCELACIÓN EN EL REGISTRO FERROVIARIO MEXICANO"));
                ...
                // ROW (TIPO DE ASIENTO)
                PdfPCell cell1Table3 = new PdfPCell(CreateCustomSubTable3_1("Cancelación"));
                ...
                PdfPCell cell2Table3 = new PdfPCell(CreateCustomSubTable3_2("Convenio Número F/166943-7", equiCan.Fechacan.ToString()));
                ...
                // ROW (JUSTIFICACION)
                PdfPCell cell3Table3 = new PdfPCell(CreateCustomSubTable3_3(equiCan.Juscan));
                ...
                // ROW (OBSERVACIONES)
                PdfPCell cell4Table3 = new PdfPCell(CreateCustomSubTable3_4(equiCan.Obscan));
                ...
                PdfPCell cell5Table3 = new PdfPCell(CreateCustomSubTable3_5(equiCan.Idcan.ToString(), equiCan.Fechaofcan.ToString()));
            ...
            static PdfPTable CreateCustomSubTable2(string Matricula,DateTime? fechaConstruccion)
            {
                ...
                Chunk textChuckValorMatricula = new Chunk(Matricula, new Font(Font.FontFamily.HELVETICA, 9f) { Color = BaseColor.BLACK });
            ...
            static PdfPTable CreateCustomSubTable2_2(string Contrato, string FechaContrato)
            {
                ...
                Chunk textChuckValorContrato = new Chunk(Contrato, new Font(Font.FontFamily.HELVETICA, 9f) { Color = BaseColor.BLACK });
                LineSeparator line = new LineSeparator(0.5f, 100, BaseColor.BLACK, Element.ALIGN_LEFT, -2);
            ...
            /*************************************************************************INICIO TABLA 3*************************************************************************/
            /*************************************************************************FIN TABLA 3*************************************************************************/
            static PdfPTable CreateCustomSubTable3_1(string Asiento)
            {
                ...
                Chunk textChuckValorMatricula = new Chunk(Asiento, new Font(Font.FontFamily.HELVETICA, 9f) { Color = BaseColor.BLACK });
                LineSeparator line = new LineSeparator(0.5f, 100, BaseColor.BLACK, Element.ALIGN_LEFT, -2);
                ...
                cell.Phrase = new Phrase($"", new Font(Font.FontFamily.HELVETICA, 9f) { Color = BaseColor.WHITE });
                subTable.AddCell(cell);
                // Puedes agregar más celdas si es necesario

                Chunk textChuckValorFecha = new Chunk("", new Font(Font.FontFamily.HELVETICA, 9f) { Color = BaseColor.WHITE });
                Phrase phraseValorFecha = new Phrase();
                phraseValorFecha.Add(textChuckValorFecha);
                //phraseValorFecha.Add(line);
                cell.Phrase = new Phrase(phraseValorFecha);
            ...
            static PdfPTable CreateCustomSubTable3_3(string Justificacion)
            {
                ...
                cell.Phrase = new Phrase($"Justificación:", new Font(Font.FontFamily.HELVETICA, 9f) { Color = BaseColor.BLACK });
                subTable.AddCell(cell);


                Chunk textChuck = new Chunk(Justificacion, new Font(Font.FontFamily.HELVETICA, 9f) { Color = BaseColor.BLACK });
                LineSeparator line = new LineSeparator(0.5f, 100, BaseColor.BLACK, Element.ALIGN_LEFT, -2);
