...
namespace ARTF2.Helpers.Constancias
{
    public class ConstanciaInscripcion
    {
        public IActionResult Generar(Equiuni equiuni)
        {
            using (var pdfStream = new MemoryStream())
            {
                ...
                // ROW (OBSERVACIONES)
                PdfPCell cell8Table2 = new PdfPCell(CreateCustomSubTable2_6(equiuni.Obsequi));
                ...
                PdfPCell cell9Table2 = new PdfPCell(CreateCustomSubTable2_7(equiuni.NumacuofsolNavigatorNavigation.Numacuofsol, equiuni.NumacuofsolNavigatorNavigation.Fecapsol.ToString()));
